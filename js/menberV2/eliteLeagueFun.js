 ...
 * element       点击的对象
 */
var memberSeleChange = function(element){
 ...
 */
var _memberSelect = function(memberSelect,thisChild){
...
/*
 * 弹出框居中
 * _this       弹框元素 - BomBox($('#BomBox'));
 */
var viewWidth=$(window).width();
var viewHeight=$(window).height();
function BomBox(_this){
    var _width=_this.width();
    var _height=_this.height();
    _this.css({'left':Math.ceil((viewWidth-_width)/2),'top' :$(window).scrollTop()+Math.ceil((viewHeight-_height)/2)});
    //点击×消失
    _this.find('.bombDele').click(function(){
